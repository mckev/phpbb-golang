...
func TestConvertBbcodeToHtml_BlockQuoteXss(t *testing.T) {
	...
	actual := bbcode.ConvertBbcodeToHtml(bbcodeStr)
	expected := `<blockquote><div><cite><a href="./users?u=123&lt;script&gt;">User&lt;script&gt;</a> wrote: <a aria-label="View quoted post" href="./posts?p=&lt;script&gt;456#p%3Cscript%3E456"><i aria-hidden="true" class="icon fa-arrow-circle-up fa-fw"></i></a><span class="responsive-hide">01 Jan 70 00:00 UTC</span></cite>text &lt;script&gt; text</div></blockquote>`
	if actual != expected {
		t.Errorf("Got %s, wanted %s", actual, expected)
		return
	}
