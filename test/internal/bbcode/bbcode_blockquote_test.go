...
func TestConvertBbcodeToHtml_BlockQuote(t *testing.T) {
	...
	bbcodeStr := `[blockquote user_name="User" user_id="123" post_id="321" time="1234567890"]text[/blockquote]`
	actual := bbcode.ConvertBbcodeToHtml(bbcodeStr)
	expected := `<blockquote><div><cite><a href="./users?u=123">User</a> wrote: <a aria-label="View quoted post" href="./posts?p=321#p321"><i aria-hidden="true" class="icon fa-arrow-circle-up fa-fw"></i></a><span class="responsive-hide">13 Feb 09 23:31 UTC</span></cite>text</div></blockquote>`
	if actual != expected {
